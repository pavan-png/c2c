...
const HeroSection = () => {
  return (
    <section id="home" className="relative overflow-hidden bg-[#f6f6f7] pt-[118px] text-[#1d1d1f]">
      <div className="mx-auto grid min-h-[calc(100vh-118px)] max-w-[1440px] items-center gap-12 px-4 py-14 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-10 lg:py-20 xl:gap-16">
        <motion.div
        ...
        >
          ...
          <motion.h1
            ...
            className="font-display text-[2.9rem] font-bold leading-[0.98] tracking-[-0.07em] text-[#1f1f24] sm:text-[3.8rem] lg:text-[4.6rem] xl:text-[5.2rem]"
          >
          ...
          <motion.p
            ...
            className="mt-7 max-w-[640px] text-[1.12rem] leading-[1.65] text-[#3f4653] sm:text-[1.25rem]"
          >
          ...
          >
            <motion.button
              ...
              className="rounded-full bg-[#5b5ce6] px-8 py-4 text-[1.02rem] font-semibold text-white shadow-[0_14px_32px_rgba(91,92,230,0.28)] transition hover:bg-[#4d4edf]"
            >
              Explore Courses
            </motion.button>
            ...
            <motion.button
              ...
              className="rounded-full border-2 border-[#1f1f24] bg-transparent px-8 py-4 text-[1.02rem] font-semibold text-[#1f1f24] transition hover:bg-[#1f1f24] hover:text-white"
            >
              Contact Us
            </motion.button>
          </motion.div>
        ...
        <motion.div
          ...
          className="relative mx-auto flex w-full max-w-[700px] items-center justify-center py-10 lg:py-0"
        >
          ...
          <motion.div
            ...
            className="relative h-[530px] w-full max-w-[620px]"
          >
            <motion.div
            ...
            >
              <img
                ...
                alt="Student learner"
                decoding="async"
                className="h-[165px] w-full object-cover mix-blend-normal opacity-95"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute bottom-[28%] right-[11%] z-20 flex h-[145px] w-[145px] items-center justify-center overflow-hidden rounded-full border-[10px] border-black bg-white shadow-[0_20px_48px_rgba(17,24,39,0.16)]"
            >
              <img
              ...
              />
              <div className="absolute left-1/2 top-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#111827] shadow-md">
                ↺
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute bottom-[11%] left-[27%] z-10 h-4 w-24 rounded-full bg-[#d5d5d8]"
            />
